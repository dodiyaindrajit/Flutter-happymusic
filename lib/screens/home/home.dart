                  ...
                  child: BackdropFilter(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(metadata.title, style: Theme.of(context).textTheme.bodyText1),
                      ],
                    ),
                  ),
                );
              ...
              StreamBuilder<LoopMode>(
                ...
                builder: (context, snapshot) {
                  ...
                  const icons = [
                    ...
                    Icon(Icons.repeat, color: ColorConstants.kHighLightColor),
                    Icon(Icons.repeat_one, color: ColorConstants.kHighLightColor),
                  ];
                  const cycleModes = [
                    LoopMode.off,
                    LoopMode.all,
                ...
                builder: (context, snapshot) {
                  ...
                  return IconButton(
                    icon: shuffleModeEnabled
                        ? const Icon(Icons.shuffle, color: ColorConstants.kHighLightColor)
          ...
          builder: (context, snapshot) => IconButton(
            icon: Text("${snapshot.data?.toStringAsFixed(1)}x",
                style: const TextStyle(
                    fontWeight: FontWeight.bold, color: ColorConstants.kHighLightColor)),
            onPressed: () {
              showSliderDialog(
                context: context,
                title: "Adjust speed",
